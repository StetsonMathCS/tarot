                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group col-sm-8">
                                                <select class="form-control" name="courseSections[0]" id="exampleFormControlSelect1">
                                                    <option>1</option>
                                                    <option>2</option>
                                                    <option>3</option>
                                                    <option>4</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group col-sm-8">
                                                <select class="form-control" name="courseCapacity[1]" id="exampleFormControlSelect1">
                                                    <option>5</option>
                                                    <option>10</option>
                                                    <option>15</option>
                                                    <option>20</option>
                                        ...
                                        <td>
                                            <div class="form-group col-sm-8">
                                                <select class="form-control" name="courseSections[1]" id="exampleFormControlSelect1">
                                                    <option>1</option>
                                                    <option>2</option>
                                                    <option>3</option>
                                                    <option>4</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group col-sm-8">
                                                <select class="form-control" name="courseCapacity[2]" id="exampleFormControlSelect1">
                                                    <option>5</option>
                                                    <option>10</option>
                                                    <option>15</option>
                                                    <option>20</option>
                                        ...
                                        <td>
                                            <div class="form-group col-sm-8">
                                                <select class="form-control" name="courseSections[2]" id="exampleFormControlSelect1">
                                                    <option>1</option>
                                                    <option>2</option>
                                                    <option>3</option>
                                                    <option>4</option>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group col-sm-8">
                                                <select class="form-control" name="roomCapacity[0]" id="exampleFormControlSelect1">
                                                    <option>1</option>
                                                    <option>2</option>
                                                    <option>3</option>
                                                    <option>4</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group col-sm-8">
                                                <select class="form-control" name="roomCapacity[1]" id="exampleFormControlSelect1">
                                                    <option>1</option>
                                                    <option>2</option>
                                                    <option>3</option>
                                                    <option>4</option>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group col-sm-8">
                                                <select class="form-control" name="facultyMaxClass[0]" id="exampleFormControlSelect1">
                                                    <option>1</option>
                                                    <option>2</option>
                                                    <option>3</option>
                                                    <option>4</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group col-sm-8">
                                                <select class="form-control" name="facultyMaxClass[1]" id="exampleFormControlSelect1">
                                                    <option>1</option>
                                                    <option>2</option>
                                                    <option>3</option>
                                                    <option>4</option>
